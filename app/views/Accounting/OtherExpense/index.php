    ...
    <div class="branch-hub-panel">
        <div class="branch-hub-filters">
            <div class="row g-3 align-items-end">
                ...
                <div class="col-sm-3 col-md-2"><div class="filter-label">Expense head</div><select id="filterLedger" class="form-select form-select-sm"><option value="">All</option><?php foreach ($ledgers as $l): ?><option value="<?= (int)$l['id'] ?>"><?= htmlspecialchars($l['ledger_name'], ENT_QUOTES) ?></option><?php endforeach; ?></select></div>
        ...
        <div id="expenseCards" class="d-md-none"></div>
    </div>
</div>
