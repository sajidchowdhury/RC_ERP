<?php
$title = $title ?? 'Two-Factor Verification';
$error = $error ?? null;
$username = $username ?? '';
?>
                ...
                <div class="card login-card">
                    <div class="card-body p-5">
                        <div class="text-center mb-4">
                            <h2 class="fw-bold text-primary">Verify identity</h2>
                            <p class="text-muted small mb-0">
                                Enter the 6-digit code from your authenticator app
                                <?php if ($username !== ''): ?>
                                    for <strong><?= htmlspecialchars($username, ENT_QUOTES) ?></strong>
                                <?php endif; ?>
                            </p>
                        </div>
                        ...
                        <form method="POST" autocomplete="off">
                            ...
                            <button type="submit" class="btn btn-primary btn-lg w-100">
                                <i class="fas fa-shield-halved me-2"></i> Verify
                            </button>
                        </form>

                        <div class="text-center mt-4">
                            <a href="<?= BASE_URL ?>auth/login" class="text-decoration-none small">Back to login</a>
                        </div>
                    </div>
                </div>
            </div>
